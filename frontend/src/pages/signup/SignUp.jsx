      ...
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <form onSubmit={handlleSubmit}>
          ...
          <div>
            ...
            <input type='password' placeholder="Enter Password" className="w-full input input-borderer h-10"
          ...
          <Link to={'/login'} className="text-sm text-black hover:underline hover:text-blue-600 inline-block">
